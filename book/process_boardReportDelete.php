...
$query = "UPDATE replyReport SET con_num = '$idx' where con_num = '$idx'+1";
mysqli_query($connect, $query);

$query = "SET @CNT=0;";
mysqli_query($connect, $query);

$query = "UPDATE replyReport SET replyReport.con_num = @CNT:=@CNT+1;";
mysqli_query($connect, $query);

$query = "ALTER TABLE replyReport AUTO_INCREMENT='$idx'+1;";
mysqli_query($connect, $query);
